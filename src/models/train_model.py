...
if __name__ == "__main__":
    ...
    os.environ['MLFLOW_TRACKING_USERNAME'] = params['ml_flow']['MLFLOW_TRACKING_USERNAME']
    os.environ['MLFLOW_TRACKING_PASSWORD'] = params['ml_flow']['MLFLOW_TRACKING_PASSWORD']
